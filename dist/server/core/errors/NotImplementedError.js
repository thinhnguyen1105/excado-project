...
function (_NotImplemented) {
  _inherits(NotImplementedError, _NotImplemented);
  ...
  function NotImplementedError() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NotImplementedError).call(this, "Not implemented"));
    _this.name = 'NotImplementedError';
    return _this;
  }

  return NotImplementedError;
}(_errors.NotImplemented);
