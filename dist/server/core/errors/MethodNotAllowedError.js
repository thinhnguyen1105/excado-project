...
function (_MethodNotAllowed) {
  _inherits(MethodNotAllowedError, _MethodNotAllowed);
  ...
  function MethodNotAllowedError() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MethodNotAllowedError).call(this, "Method not allowed"));
