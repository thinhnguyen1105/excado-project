...
var overrideConfig = {
  ...
  web: {
    cors: {
      whitelistUrls: ['http://localhost:3000', /timmay.local:3000$/, /.*\.timmay.local:3000$/]
    },
    api: {
      prefix: '/api',
      docsUrl: '/apiDocs',
  ...
  database: {
    connectionString: 'mongodb://admin:admin123@ds117145.mlab.com:17145/excado' // connectionString: 'mongodb://localhost:27017/excado',
