...
exports.newsExcelMiddleware = void 0;
...
var excelFilter = function excelFilter(_req, file, cb) {
  if (!file.originalname.match(_config.config.upload.allowExcelExt)) {
...
var newsExcelMiddleware = (0, _multer.default)({
  storage: storage,
  fileFilter: excelFilter
});
exports.newsExcelMiddleware = newsExcelMiddleware;
//# sourceMappingURL=newsExcel.middleware.js.map