...
export interface UsersService {
    ...
    find?: (params: RequestParams<UsersRepository> & {
        query: FindUsersQuery;
    }) => Promise<FindResult<User>>;
    get?: (id: string, params: RequestParams<UsersRepository>) => Promise<User>;
    create: (data: User & {
        password: string;
    }, params: RequestParams<UsersRepository> & {
        roleRepository: RolesRepository;
    }) => Promise<{
        id: string;
    }>;
    patch?: (id: string, data: PatchPayload<User>, params: RequestParams<UsersRepository> & {
        roleRepository: RolesRepository;
    }) => Promise<{}>;
    updateDetail: (id: string, data: Partial<User>, params: RequestParams<UsersRepository> & {
        roleRepository: RolesRepository;
    }) => Promise<{}>;
    ...
    checkEmailExist: (req: any, res: any) => Promise<void>;
    checkPhoneNoExist: (req: any, res: any) => Promise<void>;
}
