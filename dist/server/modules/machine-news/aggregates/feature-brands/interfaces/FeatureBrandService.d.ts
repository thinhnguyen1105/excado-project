...
export interface FeatureBrandService {
    find?: (params: RequestParams<FeatureBrandRepository> & {
        query: FindFeatureBrandsQuery;
    }) => Promise<FindResult<FeatureBrand>>;
    get?: (id: string, params: RequestParams<FeatureBrandRepository>) => Promise<FeatureBrand>;
    create: (data: FeatureBrand, params: RequestParams<FeatureBrandRepository> & {
