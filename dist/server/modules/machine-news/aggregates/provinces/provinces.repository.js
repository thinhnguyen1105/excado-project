...
exports.provinceRepository = exports.ProvinceModel = exports.ProvinceSchema = void 0;
...
var ProvinceSchema = new _mongoose.default.Schema((0, _core.addAuditableSchema)((0, _core.addDeletableSchema)({
  slug: String,
  name: String,
  totalNews: {
    type: Number,
...
var ProvinceModel = _mongoose.default.model('Province', ProvinceSchema);
    ...
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return ProvinceModel.find().sort({
              slug: 1
            });
    ...
    return _regenerator.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return ProvinceModel.findById(id).exec();
...
function () {
  ...
  _regenerator.default.mark(function _callee3(payload) {
    var newProvince, data;
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            newProvince = new ProvinceModel(payload);
            _context3.next = 3;
    ...
    return _regenerator.default.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return ProvinceModel.findByIdAndUpdate(payload._id, {
              $set: payload
            }).exec();
...
function () {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee9(provinceId) {
    return _regenerator.default.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          case 0:
            _context9.next = 2;
            return ProvinceModel.findByIdAndUpdate(provinceId, {
              $inc: {
                totalNews: 1
              }
            }).exec();
  ...
  return function increaseNewsCount(_x6) {
...
function () {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee10(provinceId) {
  ...
  return function decreaseNewsCount(_x7) {
