...
var _weightRanges = require("./weight-ranges.repository");
...
var weightRangeService = {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _weightRanges.weightRangeRepository.findAll();
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return weightRangeService[data.operation](id, data.payload, params);
  ...
  updateDetail: function () {
    ...
    _regenerator.default.mark(function _callee5(id, data, params) {
      var existedWeightRange, validationSchema;
      return _regenerator.default.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 4:
              existedWeightRange = _context5.sent;
              ...
              throw new _core.EntityNotFoundError('Weight Range');
...
var _default = weightRangeService;
exports.default = _default;
//# sourceMappingURL=weight-ranges.service.js.map