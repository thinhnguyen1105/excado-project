...
function () {
  ...
  _regenerator.default.mark(function _callee(context) {
    var categoryInfo, key;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _categories.CategoryModel.findById(context.id).exec();

          case 2:
            categoryInfo = _context.sent;

            if (categoryInfo) {
              key = "/api/categories/customs/find-category-detail/".concat(categoryInfo.slug);
