...
exports.checkFollowRecentViewed = void 0;
...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            checkFollowPromises = [];
            context.result.data.forEach(function (item) {
          ...
          case 5:
            ...
            for (i = 0; i < followResult.length; i += 1) {
              data.push(_objectSpread({}, JSONResult.data[i], {
                news: _objectSpread({}, JSONResult.data[i].news, {
                  followBy: [],
  ...
  return function checkFollowRecentViewed(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.checkFollowRecentViewed = checkFollowRecentViewed;
//# sourceMappingURL=checkFollowRecentViewed.hook.js.map