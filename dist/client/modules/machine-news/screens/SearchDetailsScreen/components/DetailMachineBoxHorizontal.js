  ...
  _createClass(DetailMachineBoxHorizontal, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_row.default, {
        ...
        style: {
          backgroundImage: "url('".concat((0, _core.getImageUrl)(this.props.imageUrl, 'small'), "')")
        },
        ...
        title: this.props.title
      }, this.props.title && _reactDeviceDetect.isMobile ? this.props.title.length > 13 ? "".concat(this.props.title, "...") : this.props.title : this.props.title), _react.default.createElement("div", {
        className: "grid-post-price"
      }, this.props.price ? (0, _core.formatMoney)(Number(this.props.price)) : '')), _react.default.createElement("div", {
        className: "grid-post-news-info"
      }, newsState && _react.default.createElement("div", null, translate('common:status'), " ", translate("common:".concat(newsState.value.toLowerCase()))), _react.default.createElement("div", null, this.props.typeOfMachine, " ", this.props.brand ? " | H\xE3ng ".concat(this.props.brand) : ''), _react.default.createElement("div", null, translate('common:owner'), " ", this.props.owner.fullName || this.props.owner.email || this.props.owner.phoneNo), _react.default.createElement("div", null, this.props.owner.phoneNo || this.props.owner.email ? "".concat(translate('common:contact-with-colon'), " ").concat(this.props.owner.phoneNo || this.props.owner.email) : ''))), _react.default.createElement(_col.default, {
        ...
        className: "location"
      }, this.props.location), this.props.currentUserId !== this.props.ownerId ? _react.default.createElement("a", null, _react.default.createElement(_icon.default, {
