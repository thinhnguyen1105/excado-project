  ...
  _createClass(ShopInfo, [{
    ...
    value: function render() {
      ...
      var ShopValidateSchema = yup.object().shape({
        ...
        address: yup.string().min(20, translate('my-shop:address-is-too-short')).max(500, translate('my-shop:address-is-too-long')).required(translate('my-shop:please-filled-your-address')),
        email: yup.string().matches(/^[a-z][a-z0-9_\.]{5,32}@[a-z0-9]{2,}(\.[a-z0-9]{2,4}){1,2}$/, translate('my-shop:invalid-email')).max(50, translate('my-shop:email-is-too-long')).email(translate('my-shop:invalid-email')).required(translate('my-shop:please-filled-your-email')),
...
var _default = (0, _i18n.withNamespaces)('my-shop')(ShopInfo);
