...
exports.AdminWeightRangesScreen = void 0;
...
require("./AdminWeightRangesScreen.less");
...
var _WeightRangeModal = _interopRequireDefault(require("./components/WeightRangeModal"));
...
var AdminWeightRanges =
/*#__PURE__*/
function (_React$Component) {
  _inherits(AdminWeightRanges, _React$Component);
  ...
  function AdminWeightRanges() {
    ...
    _classCallCheck(this, AdminWeightRanges);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AdminWeightRanges)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "openWeightRangeModal", function (selectedWeightRange) {
      _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "closeWeightRangeModal", function () {
      _this.setState({
        weightRangeModalVisible: false,
        selectedWeightRange: undefined
      });
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 9:
                _this.setState({
                  ...
                  data: _this.state.data.map(function (item) {
                    return item._id === _this.state.selectedWeightRange._id ? _objectSpread({}, item, {
                      min: values.min,
                      max: values.max
                    }) : item;
                  })
                ...
                _message2.default.success(_this.props.t('admin-weight-ranges:update-success'));
              ...
              case 15:
                ...
                _message2.default.success(_this.props.t('admin-weight-ranges:create-success'));
  ...
  _createClass(AdminWeightRanges, [{
    ...
    value: function render() {
      ...
      }), this.state.weightRangeModalVisible && _react.default.createElement(_WeightRangeModal.default, {
...
var AdminWeightRangesScreen = (0, _components.Authorize)((0, _store.withRematch)(_store.initStore, mapState, mapDispatch)((0, _i18n.withNamespaces)('admin-weight-ranges')(AdminWeightRanges)), [], true, 'admin');
exports.AdminWeightRangesScreen = AdminWeightRangesScreen;
//# sourceMappingURL=AdminWeightRangesScreen.js.map