...
var external_query_string_ = __webpack_require__(171);
...
// EXTERNAL MODULE: ./modules/machine-news/screens/CreateNewsScreen/components/CreatePost.less
var CreatePost = __webpack_require__(150);
...
// CONCATENATED MODULE: ./modules/machine-news/screens/CreateNewsScreen/CreateNewsScreen.tsx
...
var CreateNewsScreen_CreateNewsScreen =
/*#__PURE__*/
function (_Component) {
  ...
  function CreateNewsScreen(props) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 9:
                ...
                message_default.a.error(_context7.t0.message);
    ...
    function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee8(payload) {
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 12:
                ...
                message_default.a.error(_context8.t0.message);
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.next = 7;
              return Object(services["a" /* getServiceProxy */])();
            ...
            case 10:
              message_default.a.success("".concat(_this.props.t('create-news:create-successful')), 3);

              router_default.a.push('/quan-li-tin-dang');
              _context9.next = 15;
              break;

            case 14:
              message_default.a.error("".concat(_this.props.t('create-news:image-limit')), 5);
            ...
            case 18:
              ...
              message_default.a.error(_context9.t0.response || "".concat(_this.props.t('common:error-happen')));
  ...
  _createClass(CreateNewsScreen, [{
    ...
    value: function componentDidMount() {
      ...
      var query = external_query_string_default.a.parse(window.location.search);
    ...
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(components["c" /* Header */], {
        commonKeywords: this.state.commonKeywords,
        updateFilters: this.props.updateFilters,
        searchKeyword: this.props.searchKeyword,
        profileState: this.props.profileState,
...
/* harmony default export */ var screens_CreateNewsScreen_CreateNewsScreen = (Object(i18n["d" /* withNamespaces */])('create-news')(CreateNewsScreen_CreateNewsScreen));
// EXTERNAL MODULE: ./store/index.ts
var store = __webpack_require__(16);

// CONCATENATED MODULE: ./pages/create-news.tsx


function create_news_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { create_news_typeof = function _typeof(obj) { return typeof obj; }; } else { create_news_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return create_news_typeof(obj); }
...
function create_news_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function create_news_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { create_news_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { create_news_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function create_news_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function create_news_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function create_news_createClass(Constructor, protoProps, staticProps) { if (protoProps) create_news_defineProperties(Constructor.prototype, protoProps); if (staticProps) create_news_defineProperties(Constructor, staticProps); return Constructor; }

function create_news_possibleConstructorReturn(self, call) { if (call && (create_news_typeof(call) === "object" || typeof call === "function")) { return call; } return create_news_assertThisInitialized(self); }

function create_news_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function create_news_getPrototypeOf(o) { create_news_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return create_news_getPrototypeOf(o); }

function create_news_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) create_news_setPrototypeOf(subClass, superClass); }

function create_news_setPrototypeOf(o, p) { create_news_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return create_news_setPrototypeOf(o, p); }
...
var create_news_CreateNews =
/*#__PURE__*/
function (_React$Component) {
  create_news_inherits(CreateNews, _React$Component);

  function CreateNews() {
    create_news_classCallCheck(this, CreateNews);

    return create_news_possibleConstructorReturn(this, create_news_getPrototypeOf(CreateNews).apply(this, arguments));
  }

  create_news_createClass(CreateNews, [{
    key: "render",
    value: function render() {
      return external_react_["createElement"]("div", null, external_react_["createElement"](screens_CreateNewsScreen_CreateNewsScreen, {
        updateFilters: this.props.updateFilters,
        searchKeyword: this.props.searchKeyword,
        profileState: this.props.profileState,
        profileReducers: this.props.profileReducers,
    ...
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = create_news_asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                idToken = context.req ? context.req.cookies.token : external_js_cookie_["get"]('token');
                serviceProxy = Object(services["a" /* getServiceProxy */])(idToken);
                _context.next = 6;
...
/* harmony default export */ var create_news = __webpack_exports__["default"] = (Object(store["withRematch"])(store["initStore"], mapState, mapDispatch)(create_news_CreateNews));
