...
// EXTERNAL MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep1.less
var components_CreateShopStep1 = __webpack_require__(234);

// CONCATENATED MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep1.tsx
...
var CreateShopStep1_CreateShopStep1 = function CreateShopStep1(props) {
  var translate = props.t;
  return external_react_["createElement"]("div", {
    className: "step-1"
  }, external_react_["createElement"](row_default.a, {
  ...
  }), external_react_["createElement"]("h3", null, translate('create-shop:own'), external_react_["createElement"]("br", null), translate('create-shop:your-domain')), external_react_["createElement"]("span", null, translate('create-shop:own-your-domain-description'))), external_react_["createElement"](col_default.a, {
    lg: 1
  }), external_react_["createElement"](col_default.a, {
    lg: 1
  }), external_react_["createElement"](col_default.a, {
  ...
  }), external_react_["createElement"]("h3", null, translate('create-shop:customer-care')), external_react_["createElement"]("span", null, translate('create-shop:customer-care-description'))), external_react_["createElement"](col_default.a, {
    lg: 1
  }), external_react_["createElement"](col_default.a, {
    lg: 1
  }), external_react_["createElement"](col_default.a, {
  ...
  }), external_react_["createElement"]("h3", null, translate('create-shop:details')), external_react_["createElement"]("br", null), external_react_["createElement"]("span", null, translate('create-shop:details-description')), external_react_["createElement"]("span", {
    className: "icon-Youtube"
  })), external_react_["createElement"](col_default.a, {
    lg: 1
  })), external_react_["createElement"](row_default.a, null, external_react_["createElement"](button_default.a, {
...
/* harmony default export */ var CreateShopScreen_components_CreateShopStep1 = (CreateShopStep1_CreateShopStep1);
// EXTERNAL MODULE: external "antd/lib/modal/style"
var modal_style_ = __webpack_require__(42);
...
// EXTERNAL MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep2.less
var components_CreateShopStep2 = __webpack_require__(235);
...
// CONCATENATED MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep2.tsx
...
var CreateShopStep2_CreateShopStep2 = function CreateShopStep2(props) {
  var translate = props.t;
  ...
  var handleOk = function handleOk() {
    if (props.selectedPackage && props.selectedPackage.value) {
      ...
      message_default.a.error(translate('create-shop:please-select-your-shop-package-to-continue'));
    }
  };
  ...
  return external_react_default.a.createElement("div", {
  ...
  }, external_react_default.a.createElement("div", null, !external_react_device_detect_["isMobile"] ? external_react_default.a.createElement("div", null, core["s" /* storePackages */].map(function (item) {
    return external_react_default.a.createElement(row_default.a, {
      key: item.value,
      style: {
        height: 100,
      ...
      xs: 24,
      sm: 24
    }, external_react_default.a.createElement("div", null, external_react_default.a.createElement("strong", null, item.label), " s\u1EED d\u1EE5ng"), external_react_default.a.createElement("div", null, external_react_default.a.createElement("em", {
      style: {
        color: 'red',
        fontWeight: 'bold'
      }
    }, translate('create-shop:free')), " ", external_react_default.a.createElement("em", null, external_react_default.a.createElement("del", null, Object(core["c" /* formatMoney */])(item.price))))));
  })) : external_react_default.a.createElement("div", null, core["s" /* storePackages */].map(function (item) {
    return external_react_default.a.createElement("a", {
      onClick: function onClick() {
        return props.selectPackageChange({
          package: item.value
    ...
    }, external_react_default.a.createElement("strong", null, item.label), " s\u1EED d\u1EE5ng"), external_react_default.a.createElement("div", null, external_react_default.a.createElement("em", {
      style: {
        color: 'red',
        fontWeight: 'bold'
      }
    }, translate('create-shop:free')), " ", external_react_default.a.createElement("em", null, external_react_default.a.createElement("del", {
      style: {
        color: 'black'
      }
    }, Object(core["c" /* formatMoney */])(item.price)))))));
  })))));
};

/* harmony default export */ var CreateShopScreen_components_CreateShopStep2 = (CreateShopStep2_CreateShopStep2);
// EXTERNAL MODULE: external "antd/lib/form/style"
var form_style_ = __webpack_require__(40);
...
// EXTERNAL MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep3.less
var components_CreateShopStep3 = __webpack_require__(236);
...
// CONCATENATED MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep3.tsx
...
var CreateShopStep3_CreateShopStep3 =
/*#__PURE__*/
function (_React$Component) {
  ...
  function CreateShopStep3() {
    ...
    _defineProperty(_assertThisInitialized(_this), "logoImageBeforeUpload", function (file) {
      if (config["a" /* config */].upload.allowImageExt.test(file.name)) {
    ...
    _defineProperty(_assertThisInitialized(_this), "introImageBeforeUpload", function (file) {
      if (_this.props.introImageList.length < config["a" /* config */].upload.shopIntroImageNumber && config["a" /* config */].upload.allowImageExt.test(file.name)) {
        _this.props.addIntroImage(file);
      } else {
        message_default.a.error('Ảnh không quá 2MB và chỉ upload tối đa 10 ảnh');
      }
  ...
  _createClass(CreateShopStep3, [{
    ...
    value: function render() {
      ...
      var translate = this.props.t;
      var ShopValidateSchema = external_yup_["object"]().shape({
        name: external_yup_["string"]().min(5, translate('my-shop:shop-name-is-too-short')).max(50, translate('my-shop:shop-name-is-too-long')).required(translate('my-shop:please-filled-your-shop-name')),
        phone: external_yup_["string"]().matches(/^([0-9]){4,15}$/, translate('my-shop:invalid-phone-number')).required(translate('my-shop:please-filled-your-phone-number')),
        domain: external_yup_["string"]().matches(/^(?=.*[a-z0-9-])[a-z0-9-\d]{3,}$/, translate('my-shop:domain-error')).max(50, translate('my-shop:domain-is-too-long')).required(translate('my-shop:please-filled-your-domain')),
        email: external_yup_["string"]().matches(/^[a-z][a-z0-9_\.]{5,32}@[a-z0-9]{2,}(\.[a-z0-9]{2,4}){1,2}$/, translate('my-shop:invalid-email')).email(translate('my-shop:invalid-email')).required(translate('my-shop:please-filled-your-email')),
        description: external_yup_["string"]().min(50, translate('my-shop:introduce-is-too-short')).max(2000, translate('my-shop:introduce-is-too-long')).required(translate('my-shop:please-filled-your-introduce'))
      });
      ...
      return external_react_default.a.createElement(external_formik_["Formik"], {
        ...
        return external_react_default.a.createElement("div", null, external_react_default.a.createElement("div", {
          ...
          sm: 24,
          xs: 24
        }, external_react_device_detect_["isMobile"] ? external_react_default.a.createElement("div", null, external_react_default.a.createElement(card_default.a, {
          style: {
            padding: '20px 20px 0px 20px',
            margin: '0 auto',
            maxWidth: '240px'
        ...
        })), ",") : external_react_default.a.createElement("div", null), external_react_default.a.createElement(form_default.a, null, external_react_default.a.createElement(form_default.a.Item, {
        ...
        }, external_react_default.a.createElement(MapWithSearchBox["a" /* default */], {
        ...
        }))))))), !external_react_device_detect_["isMobile"] ? external_react_default.a.createElement(row_default.a, null, external_react_default.a.createElement(button_default.a, {
          type: "primary",
          onClick: function onClick() {
          ...
          className: "next-button",
          size: "large"
        }, translate('create-shop:next'))) : external_react_default.a.createElement("div", null)), external_react_device_detect_["isMobile"] ? external_react_default.a.createElement(button_default.a, {
          type: "primary",
          onClick: function onClick() {
            return context.handleSubmit();
          },
          ...
          size: "large"
        }, translate('create-shop:next')) : external_react_default.a.createElement("div", null));
      });
    }
  }]);
...
/* harmony default export */ var CreateShopScreen_components_CreateShopStep3 = (Object(i18n["d" /* withNamespaces */])('my-shop')(CreateShopStep3_CreateShopStep3));
// EXTERNAL MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep4.less
var components_CreateShopStep4 = __webpack_require__(237);

// CONCATENATED MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep4.tsx
...
function CreateShopStep4_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { CreateShopStep4_typeof = function _typeof(obj) { return typeof obj; }; } else { CreateShopStep4_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return CreateShopStep4_typeof(obj); }

function CreateShopStep4_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function CreateShopStep4_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function CreateShopStep4_createClass(Constructor, protoProps, staticProps) { if (protoProps) CreateShopStep4_defineProperties(Constructor.prototype, protoProps); if (staticProps) CreateShopStep4_defineProperties(Constructor, staticProps); return Constructor; }

function CreateShopStep4_possibleConstructorReturn(self, call) { if (call && (CreateShopStep4_typeof(call) === "object" || typeof call === "function")) { return call; } return CreateShopStep4_assertThisInitialized(self); }

function CreateShopStep4_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function CreateShopStep4_getPrototypeOf(o) { CreateShopStep4_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return CreateShopStep4_getPrototypeOf(o); }

function CreateShopStep4_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) CreateShopStep4_setPrototypeOf(subClass, superClass); }

function CreateShopStep4_setPrototypeOf(o, p) { CreateShopStep4_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return CreateShopStep4_setPrototypeOf(o, p); }
...
var CreateShopStep4_CreateShopStep4 =
/*#__PURE__*/
function (_React$Component) {
  CreateShopStep4_inherits(CreateShopStep4, _React$Component);

  function CreateShopStep4() {
    CreateShopStep4_classCallCheck(this, CreateShopStep4);

    return CreateShopStep4_possibleConstructorReturn(this, CreateShopStep4_getPrototypeOf(CreateShopStep4).apply(this, arguments));
  }

  CreateShopStep4_createClass(CreateShopStep4, [{
    key: "render",
    value: function render() {
      var _this = this;
      ...
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(row_default.a, {
        ...
        className: "title"
      }, external_react_default.a.createElement("strong", null, translate('create-shop:invoice'))), external_react_default.a.createElement("hr", {
        ...
        xs: 14,
        sm: 14
      }, external_react_default.a.createElement(row_default.a, null, external_react_default.a.createElement("div", null, translate('create-shop:store-registration-service')), external_react_default.a.createElement("div", {
        style: {
          height: 100
        }
      }, external_react_default.a.createElement("em", null, "Th\u1EDDi h\u1EA1n: \xA0", external_react_default.a.createElement("strong", null, this.props.selectedPackage ? this.props.selectedPackage.label : '')), " ")), external_react_default.a.createElement(row_default.a, {
        ...
        lg: 12
      }, external_react_default.a.createElement("span", null, translate('create-shop:total'), ": \xA0 ", external_react_default.a.createElement("span", {
        className: "price"
      }, translate('create-shop:free'))))))), external_react_default.a.createElement("hr", {
        className: "shadow-line-balance"
      }), external_react_default.a.createElement("div", {
        className: "title"
      }, external_react_default.a.createElement("strong", null, translate('create-shop:select-your-payment'))), external_react_default.a.createElement("div", {
        className: "align-text"
      }, external_react_default.a.createElement("em", null, translate('create-shop:by-using-the-store-service'), ",")), external_react_default.a.createElement("div", {
        className: "align-text"
      }, external_react_default.a.createElement("em", null, translate('create-shop:you-agree-with'), " ", external_react_default.a.createElement("a", {
        style: {
          color: '#2F8AFF'
        }
      }, translate('create-shop:term-of-use')), " ", translate('create-shop:of-timmay-vn'))), !external_react_device_detect_["isMobile"] ? external_react_default.a.createElement(button_default.a, {
        className: "button-paid",
        onClick: handlePurchaseClick,
        loading: this.props.isCreating
      }, translate('create-shop:create-shop').toUpperCase()) : external_react_default.a.createElement("div", null)), external_react_device_detect_["isMobile"] ? external_react_default.a.createElement(button_default.a, {
        className: "button-paid-mobile",
        onClick: handlePurchaseClick,
        loading: this.props.isCreating
      }, translate('create-shop:create-shop').toUpperCase()) : external_react_default.a.createElement("div", null));
    }
  }]);
...
/* harmony default export */ var CreateShopScreen_components_CreateShopStep4 = (Object(i18n["d" /* withNamespaces */])('create-shop')(CreateShopStep4_CreateShopStep4));
// EXTERNAL MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep5.less
var components_CreateShopStep5 = __webpack_require__(238);

// CONCATENATED MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopStep5.tsx
...
var CreateShopStep5_CreateShopStep5 = function CreateShopStep5(props) {
  var translate = props.t;
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement("div", {
    className: "step-5"
  }, external_react_default.a.createElement(row_default.a, {
    ...
    xs: 12
  }, !external_react_device_detect_["isMobile"] ? external_react_default.a.createElement("h1", null, translate('create-shop:congratulation'), "!") : external_react_default.a.createElement("h3", null, translate('create-shop:congratulation'), "!"), external_react_default.a.createElement("div", {
    className: "icon-container"
  }, external_react_default.a.createElement(icon_default.a, {
    type: "check-circle",
    theme: "filled",
    className: "success-icon"
  })), !external_react_device_detect_["isMobile"] ? external_react_default.a.createElement("h2", null, translate('create-shop:create-success'), "!") : external_react_default.a.createElement("h3", null, translate('create-shop:create-success'), "!"), external_react_default.a.createElement("p", null, translate('create-shop:create-success-description'), "!")))), external_react_device_detect_["isMobile"] ? external_react_default.a.createElement("a", {
    href: "/"
  }, external_react_default.a.createElement(button_default.a, {
    className: "button-back-to-home"
  }, translate('create-shop:back-to-home-page'))) : external_react_default.a.createElement("div", null));
};

/* harmony default export */ var CreateShopScreen_components_CreateShopStep5 = (CreateShopStep5_CreateShopStep5);
// EXTERNAL MODULE: external "antd/lib/progress/style"
var progress_style_ = __webpack_require__(239);

// EXTERNAL MODULE: external "antd/lib/progress"
var progress_ = __webpack_require__(193);
var progress_default = /*#__PURE__*/__webpack_require__.n(progress_);

// EXTERNAL MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopTitle.less
var components_CreateShopTitle = __webpack_require__(240);

// CONCATENATED MODULE: ./modules/machine-news/screens/CreateShopScreen/components/CreateShopTitle.tsx



function CreateShopTitle_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { CreateShopTitle_typeof = function _typeof(obj) { return typeof obj; }; } else { CreateShopTitle_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return CreateShopTitle_typeof(obj); }

function CreateShopTitle_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function CreateShopTitle_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function CreateShopTitle_createClass(Constructor, protoProps, staticProps) { if (protoProps) CreateShopTitle_defineProperties(Constructor.prototype, protoProps); if (staticProps) CreateShopTitle_defineProperties(Constructor, staticProps); return Constructor; }

function CreateShopTitle_possibleConstructorReturn(self, call) { if (call && (CreateShopTitle_typeof(call) === "object" || typeof call === "function")) { return call; } return CreateShopTitle_assertThisInitialized(self); }

function CreateShopTitle_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function CreateShopTitle_getPrototypeOf(o) { CreateShopTitle_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return CreateShopTitle_getPrototypeOf(o); }

function CreateShopTitle_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) CreateShopTitle_setPrototypeOf(subClass, superClass); }

function CreateShopTitle_setPrototypeOf(o, p) { CreateShopTitle_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return CreateShopTitle_setPrototypeOf(o, p); }
...
var CreateShopTitle_CreateShopTitle =
/*#__PURE__*/
function (_React$Component) {
  CreateShopTitle_inherits(CreateShopTitle, _React$Component);

  function CreateShopTitle() {
    CreateShopTitle_classCallCheck(this, CreateShopTitle);

    return CreateShopTitle_possibleConstructorReturn(this, CreateShopTitle_getPrototypeOf(CreateShopTitle).apply(this, arguments));
  }

  CreateShopTitle_createClass(CreateShopTitle, [{
    key: "render",
    value: function render() {
      var _this = this;
      ...
      }, external_react_["createElement"]("h3", null, translate('create-shop:create-shop')), external_react_["createElement"]("div", {
        className: "step"
      }, external_react_["createElement"]("span", {
        className: this.props.currentStep >= 1 ? "active-step-title" : "step-title"
      }, translate('create-shop:introduction')), external_react_["createElement"]("hr", {
      ...
      }, translate('create-shop:select-your-package')), external_react_["createElement"]("hr", {
      ...
      }, translate('create-shop:settings')), external_react_["createElement"]("hr", {
      ...
      }, translate('create-shop:payment')), external_react_["createElement"]("hr", {
      ...
      }, translate('create-shop:finish'))), external_react_device_detect_["isMobile"] ? external_react_["createElement"]("div", null, external_react_["createElement"](progress_default.a, {
        style: {
          top: -11
        },
        strokeColor: "#FFC500",
      ...
      }), titleForMobile()) : external_react_["createElement"]("div", null));
    }
  }]);
...
/* harmony default export */ var CreateShopScreen_components_CreateShopTitle = (Object(i18n["d" /* withNamespaces */])('create-shop')(CreateShopTitle_CreateShopTitle));
// EXTERNAL MODULE: ./services/index.ts + 1 modules
var services = __webpack_require__(5);
...
// EXTERNAL MODULE: ./modules/machine-news/screens/CreateShopScreen/CreateShopScreen.less
var CreateShopScreen_CreateShopScreen = __webpack_require__(241);

// CONCATENATED MODULE: ./modules/machine-news/screens/CreateShopScreen/CreateShopScreen.tsx
...
function CreateShopScreen_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { CreateShopScreen_typeof = function _typeof(obj) { return typeof obj; }; } else { CreateShopScreen_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return CreateShopScreen_typeof(obj); }
...
function CreateShopScreen_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function CreateShopScreen_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { CreateShopScreen_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { CreateShopScreen_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { CreateShopScreen_defineProperty(target, key, source[key]); }); } return target; }

function CreateShopScreen_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function CreateShopScreen_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function CreateShopScreen_createClass(Constructor, protoProps, staticProps) { if (protoProps) CreateShopScreen_defineProperties(Constructor.prototype, protoProps); if (staticProps) CreateShopScreen_defineProperties(Constructor, staticProps); return Constructor; }

function CreateShopScreen_possibleConstructorReturn(self, call) { if (call && (CreateShopScreen_typeof(call) === "object" || typeof call === "function")) { return call; } return CreateShopScreen_assertThisInitialized(self); }

function CreateShopScreen_getPrototypeOf(o) { CreateShopScreen_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return CreateShopScreen_getPrototypeOf(o); }

function CreateShopScreen_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function CreateShopScreen_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) CreateShopScreen_setPrototypeOf(subClass, superClass); }

function CreateShopScreen_setPrototypeOf(o, p) { CreateShopScreen_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return CreateShopScreen_setPrototypeOf(o, p); }

function CreateShopScreen_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var CreateShopScreen_CreateShopScreen_CreateShopScreen =
/*#__PURE__*/
function (_React$Component) {
  CreateShopScreen_inherits(CreateShopScreen, _React$Component);
  ...
  function CreateShopScreen() {
    ...
    CreateShopScreen_classCallCheck(this, CreateShopScreen);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = CreateShopScreen_possibleConstructorReturn(this, (_getPrototypeOf2 = CreateShopScreen_getPrototypeOf(CreateShopScreen)).call.apply(_getPrototypeOf2, [this].concat(args)));

    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "state", {
      currentStep: 1,
    ...
    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "nextStep", function () {
      _this.setState({
        currentStep: _this.state.currentStep + 1
      });
    });

    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "backStep", function () {
      _this.setState({
        currentStep: _this.state.currentStep - 1
      });
    });

    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "handleShopInfoChange", function (payload) {
      _this.setState({
        shopInfo: _objectSpread({}, _this.state.shopInfo, payload)
      });
    });

    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "createShop",
    /*#__PURE__*/
    CreateShopScreen_asyncToGenerator(
    /*#__PURE__*/
    regenerator_default.a.mark(function _callee() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return fetch("".concat(config["a" /* config */].url.api, "/upload-image/shop-intro-images"), {
                method: 'POST',
            ...
            case 8:
              ...
              _context.next = 13;
              return fetch("".concat(config["a" /* config */].url.api, "/upload-image/shop-logo-image"), {
                method: 'POST',
            ...
            case 26:
              ...
              message_default.a.error(JSON.parse(_context.t0.response).message || _context.t0.message);
    ...
    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "selectPackageChange", function (payload) {
      _this.setState({
        selectedPackage: core["s" /* storePackages */].filter(function (item) {
          return item.value === payload.package;
        })[0]
      });
    });

    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "paymentMethodChange", function (payload) {
      _this.setState({
        selectedPaymentMethod: core["o" /* paymentMethods */].filter(function (item) {
          return item.value === payload.paymentMethod;
        })[0]
      });
    });

    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "addIntroImage", function (file) {
      Object(core["f" /* getBase64Image */])(file, function (base64Url) {
        _this.setState({
    ...
    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "removeIntroImage", function (file) {
    ...
    CreateShopScreen_defineProperty(CreateShopScreen_assertThisInitialized(_this), "changeLogoImage", function (file) {
      Object(core["f" /* getBase64Image */])(file, function (base64Url) {
        _this.setState({
          logoImageList: [{
            file: file,
  ...
  CreateShopScreen_createClass(CreateShopScreen, [{
    key: "render",
    value: function render() {
      return external_react_["createElement"]("div", {
        ...
        profileState: this.props.profileState,
        profileReducers: this.props.profileReducers
      }, external_react_["createElement"](CreateShopScreen_components_CreateShopTitle, {
        ...
        tab: "Step 1",
        key: "1"
      }, external_react_["createElement"](CreateShopScreen_components_CreateShopStep1, {
        nextStep: this.nextStep,
        t: this.props.t
      })), external_react_["createElement"](TabPane, {
        tab: "Step 2",
        key: "2"
      }, external_react_["createElement"](CreateShopScreen_components_CreateShopStep2, {
        t: this.props.t,
        ...
        tab: "Step 3",
        key: "3"
      }, external_react_["createElement"](CreateShopScreen_components_CreateShopStep3, {
        nextStep: this.nextStep,
        ...
        tab: "Step 4",
        key: "4"
      }, external_react_["createElement"](CreateShopScreen_components_CreateShopStep4, {
        ...
        tab: "Step 5",
        key: "5"
      }, external_react_["createElement"](CreateShopScreen_components_CreateShopStep5, {
        t: this.props.t
      })))));
    }
  }]);
...
/* harmony default export */ var screens_CreateShopScreen_CreateShopScreen = (Object(i18n["d" /* withNamespaces */])('create-shop')(CreateShopScreen_CreateShopScreen_CreateShopScreen));
// EXTERNAL MODULE: ./store/index.ts
var store = __webpack_require__(16);

// CONCATENATED MODULE: ./pages/create-shop.tsx


function create_shop_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { create_shop_typeof = function _typeof(obj) { return typeof obj; }; } else { create_shop_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return create_shop_typeof(obj); }

function create_shop_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function create_shop_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { create_shop_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { create_shop_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function create_shop_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function create_shop_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function create_shop_createClass(Constructor, protoProps, staticProps) { if (protoProps) create_shop_defineProperties(Constructor.prototype, protoProps); if (staticProps) create_shop_defineProperties(Constructor, staticProps); return Constructor; }

function create_shop_possibleConstructorReturn(self, call) { if (call && (create_shop_typeof(call) === "object" || typeof call === "function")) { return call; } return create_shop_assertThisInitialized(self); }

function create_shop_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function create_shop_getPrototypeOf(o) { create_shop_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return create_shop_getPrototypeOf(o); }

function create_shop_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) create_shop_setPrototypeOf(subClass, superClass); }

function create_shop_setPrototypeOf(o, p) { create_shop_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return create_shop_setPrototypeOf(o, p); }





var Fragment = external_react_default.a.Fragment;

var create_shop_CreateShop =
/*#__PURE__*/
function (_React$Component) {
  create_shop_inherits(CreateShop, _React$Component);

  function CreateShop() {
    create_shop_classCallCheck(this, CreateShop);

    return create_shop_possibleConstructorReturn(this, create_shop_getPrototypeOf(CreateShop).apply(this, arguments));
  }

  create_shop_createClass(CreateShop, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(Fragment, null, external_react_default.a.createElement(screens_CreateShopScreen_CreateShopScreen, {
        searchKeyword: this.props.searchKeyword,
        topBrands: this.props.topBrands,
        profileState: this.props.profileState,
        profileReducers: this.props.profileReducers,
    ...
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = create_shop_asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(context) {
        var servicePropxy, topBrands;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                servicePropxy = Object(services["a" /* getServiceProxy */])();
                _context.next = 3;
                return servicePropxy.findTopBrands();

              case 3:
                topBrands = _context.sent;
                return _context.abrupt("return", {
...
/* harmony default export */ var create_shop = __webpack_exports__["default"] = (Object(store["withRematch"])(store["initStore"], mapState, mapDispatch)(create_shop_CreateShop));
