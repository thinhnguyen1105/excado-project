...
// EXTERNAL MODULE: ./modules/machine-news/screens/ShopNewsScreen/components/ShopNewsDetails.less
var components_ShopNewsDetails = __webpack_require__(283);

// EXTERNAL MODULE: external "react-device-detect"
var external_react_device_detect_ = __webpack_require__(29);

// CONCATENATED MODULE: ./modules/machine-news/screens/ShopNewsScreen/components/ShopNewsDetails.tsx
...
var ShopNewsDetails_ShopNewsDetails =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(ShopNewsDetails, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(row_default.a, {
      ...
      }, "T\u1EA5t c\u1EA3 s\u1EA3n ph\u1EA9m")), external_react_default.a.createElement(col_default.a, {
      ...
      }, "B\u1ED9 l\u1ECDc ", external_react_default.a.createElement(icon_default.a, {
        type: "filter"
      })))), this.state.isOpenFilter && external_react_device_detect_["isMobile"] ? external_react_default.a.createElement(row_default.a, null, external_react_default.a.createElement(SearchBar["a" /* default */], {
      ...
      }, "\u1EA8n b\u1ED9 l\u1ECDc"))) : external_react_default.a.createElement("div", null), !external_react_device_detect_["isMobile"] ? external_react_default.a.createElement(row_default.a, null, external_react_default.a.createElement(SearchBar["a" /* default */], {
        searchKeywords: this.props.searchKeywords,
        handleSearchChange: this.props.handleSearchChange,
        handleFiltersChange: this.props.handleFiltersChange,
        t: this.props.t
        ...
        selectedWeightRange: this.props.selectedWeightRange,
        handleFiltersChange: this.props.handleFiltersChange
      })) : external_react_default.a.createElement("div", null), external_react_default.a.createElement(spin_default.a, {
...
/* harmony default export */ var ShopNewsScreen_components_ShopNewsDetails = (ShopNewsDetails_ShopNewsDetails);
...
// CONCATENATED MODULE: ./modules/machine-news/screens/ShopNewsScreen/ShopNewsScreen.tsx




function ShopNewsScreen_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { ShopNewsScreen_typeof = function _typeof(obj) { return typeof obj; }; } else { ShopNewsScreen_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return ShopNewsScreen_typeof(obj); }

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { ShopNewsScreen_defineProperty(target, key, source[key]); }); } return target; }

function ShopNewsScreen_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function ShopNewsScreen_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function ShopNewsScreen_createClass(Constructor, protoProps, staticProps) { if (protoProps) ShopNewsScreen_defineProperties(Constructor.prototype, protoProps); if (staticProps) ShopNewsScreen_defineProperties(Constructor, staticProps); return Constructor; }

function ShopNewsScreen_possibleConstructorReturn(self, call) { if (call && (ShopNewsScreen_typeof(call) === "object" || typeof call === "function")) { return call; } return ShopNewsScreen_assertThisInitialized(self); }

function ShopNewsScreen_getPrototypeOf(o) { ShopNewsScreen_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return ShopNewsScreen_getPrototypeOf(o); }

function ShopNewsScreen_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function ShopNewsScreen_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) ShopNewsScreen_setPrototypeOf(subClass, superClass); }

function ShopNewsScreen_setPrototypeOf(o, p) { ShopNewsScreen_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return ShopNewsScreen_setPrototypeOf(o, p); }

function ShopNewsScreen_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var ShopNewsScreen_ShopNewsScreen =
/*#__PURE__*/
function (_Component) {
  ShopNewsScreen_inherits(ShopNewsScreen, _Component);
  ...
  function ShopNewsScreen() {
    ...
    ShopNewsScreen_classCallCheck(this, ShopNewsScreen);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = ShopNewsScreen_possibleConstructorReturn(this, (_getPrototypeOf2 = ShopNewsScreen_getPrototypeOf(ShopNewsScreen)).call.apply(_getPrototypeOf2, [this].concat(args)));

    ShopNewsScreen_defineProperty(ShopNewsScreen_assertThisInitialized(_this), "state", {
      filters: {
        keyword: undefined,
        state: undefined,
        priceType: undefined,
    ...
    ShopNewsScreen_defineProperty(ShopNewsScreen_assertThisInitialized(_this), "handleSearchChange", function (payload) {
      _this.setState({
        filters: _objectSpread({}, _this.state.filters, payload)
      });
    });

    ShopNewsScreen_defineProperty(ShopNewsScreen_assertThisInitialized(_this), "handleFiltersChange",
    /*#__PURE__*/
    function () {
      var _ref = _asyncToGenerator(
      /*#__PURE__*/
    ...
    ShopNewsScreen_defineProperty(ShopNewsScreen_assertThisInitialized(_this), "getNextPage",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    ...
    ShopNewsScreen_defineProperty(ShopNewsScreen_assertThisInitialized(_this), "getPrevPage",
    /*#__PURE__*/
    _asyncToGenerator(
    /*#__PURE__*/
    ...
    ShopNewsScreen_defineProperty(ShopNewsScreen_assertThisInitialized(_this), "changeFollowItemStatus",
    /*#__PURE__*/
    function () {
  ...
  ShopNewsScreen_createClass(ShopNewsScreen, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "".concat(this.props.shopInfo.name, " | timmay.vn")), external_react_default.a.createElement("meta", {
        ...
        t: this.props.t
      }), external_react_default.a.createElement(ShopNewsScreen_components_ShopNewsDetails, {
...
/* harmony default export */ var screens_ShopNewsScreen_ShopNewsScreen = (Object(i18n["d" /* withNamespaces */])('detail-news')(ShopNewsScreen_ShopNewsScreen));
...
// CONCATENATED MODULE: ./pages/shop-news.tsx


function shop_news_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { shop_news_typeof = function _typeof(obj) { return typeof obj; }; } else { shop_news_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return shop_news_typeof(obj); }
...
function shop_news_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function shop_news_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { shop_news_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { shop_news_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function shop_news_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function shop_news_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function shop_news_createClass(Constructor, protoProps, staticProps) { if (protoProps) shop_news_defineProperties(Constructor.prototype, protoProps); if (staticProps) shop_news_defineProperties(Constructor, staticProps); return Constructor; }

function shop_news_possibleConstructorReturn(self, call) { if (call && (shop_news_typeof(call) === "object" || typeof call === "function")) { return call; } return shop_news_assertThisInitialized(self); }

function shop_news_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function shop_news_getPrototypeOf(o) { shop_news_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return shop_news_getPrototypeOf(o); }

function shop_news_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) shop_news_setPrototypeOf(subClass, superClass); }

function shop_news_setPrototypeOf(o, p) { shop_news_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return shop_news_setPrototypeOf(o, p); }
...
var shop_news_AllProducts =
/*#__PURE__*/
function (_Component) {
  shop_news_inherits(AllProducts, _Component);

  function AllProducts() {
    shop_news_classCallCheck(this, AllProducts);

    return shop_news_possibleConstructorReturn(this, shop_news_getPrototypeOf(AllProducts).apply(this, arguments));
  }

  shop_news_createClass(AllProducts, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(screens_ShopNewsScreen_ShopNewsScreen, {
        resultSearchNewestPost: this.props.resultSearchNewestPost,
    ...
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = shop_news_asyncToGenerator(
      /*#__PURE__*/
...
/* harmony default export */ var shop_news = __webpack_exports__["default"] = (Object(store["withRematch"])(store["initStore"], mapState, mapDispatch)(shop_news_AllProducts));
