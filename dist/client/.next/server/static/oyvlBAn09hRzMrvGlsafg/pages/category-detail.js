...
// EXTERNAL MODULE: ./modules/machine-news/screens/CategoryDetailScreen/CategoryDetailScreen.less
var CategoryDetailScreen_CategoryDetailScreen = __webpack_require__(231);
...
// CONCATENATED MODULE: ./modules/machine-news/screens/CategoryDetailScreen/CategoryDetailScreen.tsx
...
var CategoryDetailScreen_CategoryDetailScreen_CategoryDetailScreen =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(CategoryDetailScreen, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "".concat(this.props.categoryDetail ? this.props.categoryDetail.name : this.props.categoryName, " | timmay.vn")), external_react_default.a.createElement("meta", {
        property: "fb:app_id",
        ...
        property: "og:url",
        content: "".concat(config["a" /* config */].url.main, "/chung-loai-may/").concat(this.props.categoryDetail._id)
      }), external_react_default.a.createElement("meta", {
        property: "og:type",
        content: "website"
      }), external_react_default.a.createElement("meta", {
        ...
        return external_react_default.a.createElement(row_default.a, {
          ...
          xs: 24
        }, external_react_default.a.createElement("h2", null, external_react_default.a.createElement("a", {
          ...
          return external_react_default.a.createElement(col_default.a, {
            ...
            sm: 12,
            xs: 24
          }, external_react_default.a.createElement("ul", null, external_react_default.a.createElement("a", {
...
/* harmony default export */ var screens_CategoryDetailScreen_CategoryDetailScreen = (CategoryDetailScreen_CategoryDetailScreen_CategoryDetailScreen);
// EXTERNAL MODULE: ./services/index.ts + 1 modules
var services = __webpack_require__(5);

// EXTERNAL MODULE: external "lodash/startCase"
var startCase_ = __webpack_require__(170);
var startCase_default = /*#__PURE__*/__webpack_require__.n(startCase_);

// CONCATENATED MODULE: ./pages/category-detail.tsx


function category_detail_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { category_detail_typeof = function _typeof(obj) { return typeof obj; }; } else { category_detail_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return category_detail_typeof(obj); }
...
function category_detail_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function category_detail_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function category_detail_createClass(Constructor, protoProps, staticProps) { if (protoProps) category_detail_defineProperties(Constructor.prototype, protoProps); if (staticProps) category_detail_defineProperties(Constructor, staticProps); return Constructor; }

function category_detail_possibleConstructorReturn(self, call) { if (call && (category_detail_typeof(call) === "object" || typeof call === "function")) { return call; } return category_detail_assertThisInitialized(self); }

function category_detail_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function category_detail_getPrototypeOf(o) { category_detail_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return category_detail_getPrototypeOf(o); }

function category_detail_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) category_detail_setPrototypeOf(subClass, superClass); }

function category_detail_setPrototypeOf(o, p) { category_detail_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return category_detail_setPrototypeOf(o, p); }
...
var category_detail_CategoryDetail =
/*#__PURE__*/
function (_React$Component) {
  category_detail_inherits(CategoryDetail, _React$Component);

  function CategoryDetail() {
    category_detail_classCallCheck(this, CategoryDetail);

    return category_detail_possibleConstructorReturn(this, category_detail_getPrototypeOf(CategoryDetail).apply(this, arguments));
  }

  category_detail_createClass(CategoryDetail, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(screens_CategoryDetailScreen_CategoryDetailScreen, {
    ...
    value: function () {
      ...
      regenerator_default.a.mark(function _callee(context) {
        var categorySlug, serviceProxy, _ref, _ref2, categoryDetail, topBrands;

        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                categorySlug = context.asPath.split('/')[context.asPath.split('/').length - 1];
                serviceProxy = Object(services["a" /* getServiceProxy */])();
                _context.next = 4;
                return Promise.all([serviceProxy.findCategoryDetail(categorySlug), serviceProxy.findTopBrands()]);

              case 4:
                _ref = _context.sent;
                _ref2 = _slicedToArray(_ref, 2);
                categoryDetail = _ref2[0];
                topBrands = _ref2[1];
                return _context.abrupt("return", {
                  namespacesRequired: ['common', 'brand-detail'],
                  categoryDetail: categoryDetail,
                  topBrands: topBrands.data,
                  categoryName: startCase_default()(categorySlug)
                });
...
/* harmony default export */ var category_detail = __webpack_exports__["default"] = (Object(store["withRematch"])(store["initStore"], mapState, mapDispatch)(Object(i18n["d" /* withNamespaces */])('category-detail')(category_detail_CategoryDetail)));
