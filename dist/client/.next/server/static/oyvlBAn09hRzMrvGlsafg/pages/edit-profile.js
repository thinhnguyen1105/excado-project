...
// EXTERNAL MODULE: ./modules/auth/screens/EditProfileScreen/EditProfileScreen.less
var EditProfileScreen_EditProfileScreen = __webpack_require__(250);

// EXTERNAL MODULE: external "antd/lib/table/style"
var table_style_ = __webpack_require__(58);
...
// CONCATENATED MODULE: ./modules/auth/screens/EditProfileScreen/components/UserProfileForm.tsx
...
var UserProfileForm_EditableRow = function EditableRow(_ref) {
  var form = _ref.form,
      index = _ref.index,
...
var EditableFormRow = form_default.a.create()(UserProfileForm_EditableRow);

var UserProfileForm_EditableCell =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(EditableCell, [{
    ...
    value: function render() {
      ...
      var renderForm = function renderForm(record, form) {
        ...
        switch (record.key) {
          case 'name':
            return external_react_default.a.createElement(form_default.a, null, external_react_default.a.createElement(FormItem, {
              style: {
                margin: 0
              }
          ...
          case 'phoneNo':
            return external_react_default.a.createElement(FormItem, {
              style: {
                margin: 0
              }
              ...
              rules: [{
                ...
                pattern: config["a" /* config */].regex.phone,
      ...
      return external_react_default.a.createElement(EditableContext.Consumer, null, function (form) {
        return external_react_default.a.createElement("td", restProps, editing ? renderForm(_this.props.record, form) : external_react_default.a.createElement("div", {
          style: {
...
var UserProfileForm_EditableTable =
/*#__PURE__*/
function (_React$Component2) {
  ...
  function EditableTable(props) {
    ...
    _this2.columns = [{
      title: 'Label',
      dataIndex: 'label',
      width: external_react_device_detect_["isMobile"] ? '30%' : '20%',
      editable: false
    }, {
      title: 'Value',
      dataIndex: 'value',
      width: external_react_device_detect_["isMobile"] ? '50%' : '50%',
      editable: true,
      ...
      render: function render(_text, record) {
        ...
        return external_react_default.a.createElement("div", null, editable ? external_react_default.a.createElement("span", null, external_react_default.a.createElement(EditableContext.Consumer, null, function (form) {
          ...
          icon: "close"
        }, translate('edit-profile:cancel'))) : external_react_default.a.createElement(button_default.a, {
          onClick: function onClick() {
  ...
  _createClass(EditableTable, [{
    ...
    value: function save(form, key) {
      ...
      function () {
        var _ref2 = _asyncToGenerator(
        /*#__PURE__*/
        regenerator_default.a.mark(function _callee(error, row) {
          var success;
          return regenerator_default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
    ...
    value: function render() {
      ...
      var components = {
        body: {
          row: EditableFormRow,
          cell: UserProfileForm_EditableCell
        }
      };
...
var UserProfileForm_UserProfileForm =
/*#__PURE__*/
function (_React$Component3) {
  ...
  _createClass(UserProfileForm, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(UserProfileForm_EditableTable, {
...
/* harmony default export */ var components_UserProfileForm = (UserProfileForm_UserProfileForm);
// EXTERNAL MODULE: ./core/index.ts + 20 modules
var core = __webpack_require__(4);

// EXTERNAL MODULE: external "firebase"
var external_firebase_ = __webpack_require__(194);
...
// CONCATENATED MODULE: ./modules/auth/screens/EditProfileScreen/EditProfileScreen.tsx
...
function EditProfileScreen_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { EditProfileScreen_typeof = function _typeof(obj) { return typeof obj; }; } else { EditProfileScreen_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return EditProfileScreen_typeof(obj); }

function EditProfileScreen_objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { EditProfileScreen_defineProperty(target, key, source[key]); }); } return target; }

function EditProfileScreen_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function EditProfileScreen_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { EditProfileScreen_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { EditProfileScreen_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function EditProfileScreen_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function EditProfileScreen_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function EditProfileScreen_createClass(Constructor, protoProps, staticProps) { if (protoProps) EditProfileScreen_defineProperties(Constructor.prototype, protoProps); if (staticProps) EditProfileScreen_defineProperties(Constructor, staticProps); return Constructor; }

function EditProfileScreen_possibleConstructorReturn(self, call) { if (call && (EditProfileScreen_typeof(call) === "object" || typeof call === "function")) { return call; } return EditProfileScreen_assertThisInitialized(self); }

function EditProfileScreen_getPrototypeOf(o) { EditProfileScreen_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return EditProfileScreen_getPrototypeOf(o); }

function EditProfileScreen_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function EditProfileScreen_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) EditProfileScreen_setPrototypeOf(subClass, superClass); }

function EditProfileScreen_setPrototypeOf(o, p) { EditProfileScreen_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return EditProfileScreen_setPrototypeOf(o, p); }

function EditProfileScreen_defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var EditProfileScreen_EditProfileScreen_EditProfileScreen =
/*#__PURE__*/
function (_React$Component) {
  EditProfileScreen_inherits(EditProfileScreen, _React$Component);
  ...
  function EditProfileScreen() {
    ...
    EditProfileScreen_classCallCheck(this, EditProfileScreen);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = EditProfileScreen_possibleConstructorReturn(this, (_getPrototypeOf2 = EditProfileScreen_getPrototypeOf(EditProfileScreen)).call.apply(_getPrototypeOf2, [this].concat(args)));

    EditProfileScreen_defineProperty(EditProfileScreen_assertThisInitialized(_this), "state", {
      loading: false,
      userProfile: _this.props.userProfile,
      avatarImageList: []
    });

    EditProfileScreen_defineProperty(EditProfileScreen_assertThisInitialized(_this), "editUserProfile",
    /*#__PURE__*/
    function () {
      var _ref = EditProfileScreen_asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                Object(core["j" /* initializeFirebaseApp */])();
                _context.next = 5;
                return external_firebase_default.a.auth().currentUser.getIdToken();
              ...
              case 9:
                _this.setState({
                  loading: false,
                  userProfile: EditProfileScreen_objectSpread({}, _this.state.userProfile, payload)
                });
                ...
                message_default.a.success(_this.props.t('edit-profile:updateProfileSuccess'));
    ...
    EditProfileScreen_defineProperty(EditProfileScreen_assertThisInitialized(_this), "uploadAvatar",
    /*#__PURE__*/
    function () {
      var _ref2 = EditProfileScreen_asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return fetch("".concat(config["a" /* config */].url.api, "/upload-image/avatar-image"), {
                  method: 'POST',
              ...
              case 8:
                _this.setState({
                  userProfile: EditProfileScreen_objectSpread({}, _this.state.userProfile, avatarImageResult)
                });
    ...
    EditProfileScreen_defineProperty(EditProfileScreen_assertThisInitialized(_this), "avatarImageBeforeUpload",
    /*#__PURE__*/
    function () {
      var _ref3 = EditProfileScreen_asyncToGenerator(
      /*#__PURE__*/
  ...
  EditProfileScreen_createClass(EditProfileScreen, [{
    key: "render",
    value: function render() {
      var translate = this.props.t;
      return external_react_default.a.createElement("div", {
        ...
        cover: external_react_default.a.createElement("div", {
        ...
        sm: 24,
        xs: 24
      }, external_react_default.a.createElement(components_UserProfileForm, {
...
/* harmony default export */ var screens_EditProfileScreen_EditProfileScreen = (Object(i18n["d" /* withNamespaces */])('edit-profile')(EditProfileScreen_EditProfileScreen_EditProfileScreen));
// EXTERNAL MODULE: external "js-cookie"
var external_js_cookie_ = __webpack_require__(33);

// CONCATENATED MODULE: ./pages/edit-profile.tsx


function edit_profile_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { edit_profile_typeof = function _typeof(obj) { return typeof obj; }; } else { edit_profile_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return edit_profile_typeof(obj); }

function edit_profile_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function edit_profile_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { edit_profile_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { edit_profile_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function edit_profile_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function edit_profile_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function edit_profile_createClass(Constructor, protoProps, staticProps) { if (protoProps) edit_profile_defineProperties(Constructor.prototype, protoProps); if (staticProps) edit_profile_defineProperties(Constructor, staticProps); return Constructor; }

function edit_profile_possibleConstructorReturn(self, call) { if (call && (edit_profile_typeof(call) === "object" || typeof call === "function")) { return call; } return edit_profile_assertThisInitialized(self); }

function edit_profile_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function edit_profile_getPrototypeOf(o) { edit_profile_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return edit_profile_getPrototypeOf(o); }

function edit_profile_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) edit_profile_setPrototypeOf(subClass, superClass); }

function edit_profile_setPrototypeOf(o, p) { edit_profile_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return edit_profile_setPrototypeOf(o, p); }
...
var edit_profile_EditProfile =
/*#__PURE__*/
function (_React$Component) {
  edit_profile_inherits(EditProfile, _React$Component);

  function EditProfile() {
    edit_profile_classCallCheck(this, EditProfile);

    return edit_profile_possibleConstructorReturn(this, edit_profile_getPrototypeOf(EditProfile).apply(this, arguments));
  }

  edit_profile_createClass(EditProfile, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(Fragment, null, external_react_default.a.createElement(screens_EditProfileScreen_EditProfileScreen, {
        updateFilters: this.props.updateFilters,
    ...
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = edit_profile_asyncToGenerator(
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(context) {
        var profileData, provinces, idToken, serviceProxies, _serviceProxies;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                profileData = _context.sent;
                _context.next = 8;
                return serviceProxies.findProvinces();
              ...
              case 14:
                profileData = _context.sent;
                _context.next = 17;
                return _serviceProxies.findProvinces();
...
/* harmony default export */ var edit_profile = __webpack_exports__["default"] = (Object(store["withRematch"])(store["initStore"], mapState, mapDispatch)(edit_profile_EditProfile));
