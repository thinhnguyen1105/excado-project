...
// EXTERNAL MODULE: /Volumes/Data/Techkids Software/excado/node_modules/react-image-gallery/styles/css/image-gallery.css
var image_gallery = __webpack_require__(165);

// CONCATENATED MODULE: ./modules/machine-news/screens/ImageFullScreenNewsDetailScreen/ImageFullScreenNewsDetailScreen.tsx
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var ImageFullScreenNewsDetailScreen_images = [];

var ImageFullScreenNewsDetailScreen_ImageFullScreenNewsDetailScreen =
/*#__PURE__*/
function (_React$Component) {
  ...
  function ImageFullScreenNewsDetailScreen(props) {
    ...
    _this.imageGallery = external_react_["createRef"]();
    return _this;
  }
  ...
  _createClass(ImageFullScreenNewsDetailScreen, [{
    ...
    value: function render() {
      ...
      ImageFullScreenNewsDetailScreen_images = this.props.newsData.imageUrls.length > 0 ? this.props.newsData.imageUrls.map(function (value) {
        return {
          original: Object(core["g" /* getImageUrl */])(value, 'large') ? Object(core["g" /* getImageUrl */])(value, 'large') : _this2.props.newsData.categoryId.imageUrl
        };
      }) : [{
        original: '/static/images/sample-machine.png',
        thumbnail: '/static/images/sample-machine.png'
      }];
      var renderImages = ImageFullScreenNewsDetailScreen_images.map(function (value) {
      ...
      return external_react_["createElement"](external_react_["Fragment"], null, external_react_["createElement"](CommonLayout["a" /* default */], {
        updateFilters: this.props.updateFilters,
        topBrands: this.props.topBrands,
        searchKeyword: this.props.searchKeyword,
        hasSideBar: false,
...
/* harmony default export */ var screens_ImageFullScreenNewsDetailScreen_ImageFullScreenNewsDetailScreen = (ImageFullScreenNewsDetailScreen_ImageFullScreenNewsDetailScreen);
// EXTERNAL MODULE: ./i18n/index.ts + 1 modules
var i18n = __webpack_require__(10);

// CONCATENATED MODULE: ./pages/image-fullscreen-news-detail.tsx


function image_fullscreen_news_detail_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { image_fullscreen_news_detail_typeof = function _typeof(obj) { return typeof obj; }; } else { image_fullscreen_news_detail_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return image_fullscreen_news_detail_typeof(obj); }

function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }

function image_fullscreen_news_detail_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function image_fullscreen_news_detail_defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function image_fullscreen_news_detail_createClass(Constructor, protoProps, staticProps) { if (protoProps) image_fullscreen_news_detail_defineProperties(Constructor.prototype, protoProps); if (staticProps) image_fullscreen_news_detail_defineProperties(Constructor, staticProps); return Constructor; }

function image_fullscreen_news_detail_possibleConstructorReturn(self, call) { if (call && (image_fullscreen_news_detail_typeof(call) === "object" || typeof call === "function")) { return call; } return image_fullscreen_news_detail_assertThisInitialized(self); }

function image_fullscreen_news_detail_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function image_fullscreen_news_detail_getPrototypeOf(o) { image_fullscreen_news_detail_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return image_fullscreen_news_detail_getPrototypeOf(o); }

function image_fullscreen_news_detail_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) image_fullscreen_news_detail_setPrototypeOf(subClass, superClass); }

function image_fullscreen_news_detail_setPrototypeOf(o, p) { image_fullscreen_news_detail_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return image_fullscreen_news_detail_setPrototypeOf(o, p); }
...
var image_fullscreen_news_detail_ImageFullScreenNewsDetail =
/*#__PURE__*/
function (_React$Component) {
  image_fullscreen_news_detail_inherits(ImageFullScreenNewsDetail, _React$Component);

  function ImageFullScreenNewsDetail() {
    image_fullscreen_news_detail_classCallCheck(this, ImageFullScreenNewsDetail);

    return image_fullscreen_news_detail_possibleConstructorReturn(this, image_fullscreen_news_detail_getPrototypeOf(ImageFullScreenNewsDetail).apply(this, arguments));
  }

  image_fullscreen_news_detail_createClass(ImageFullScreenNewsDetail, [{
    key: "render",
    value: function render() {
      return external_react_["createElement"](external_react_["Fragment"], null, external_react_["createElement"](screens_ImageFullScreenNewsDetailScreen_ImageFullScreenNewsDetailScreen, {
    ...
    value: function () {
      ...
      regenerator_default.a.mark(function _callee(context) {
        var serviceProxies, newsData, topBrands;
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                serviceProxies = Object(services["a" /* getServiceProxy */])();
                _context.next = 3;
                return serviceProxies.findNewsById(context.query.id);

              case 3:
                newsData = _context.sent;
                _context.next = 6;
                return serviceProxies.findTopBrands();
  ...
  return ImageFullScreenNewsDetail;
}(external_react_["Component"]);
...
/* harmony default export */ var image_fullscreen_news_detail = __webpack_exports__["default"] = (Object(store["withRematch"])(store["initStore"], mapState, mapDispatch)(Object(i18n["d" /* withNamespaces */])('image-fullscreen-news-detail')(image_fullscreen_news_detail_ImageFullScreenNewsDetail)));
