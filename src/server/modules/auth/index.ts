...
export * from './aggregates/users/interfaces/FollowUserQuery';
export * from './aggregates/users/interfaces/UpdateFollower';
export * from './aggregates/users/interfaces/UsersService';
export * from './aggregates/users/interfaces/UsersRepository';
export * from './aggregates/users/interfaces/UpdateFollower';
export * from './aggregates/users/interfaces/CheckFollow';
...
export * from './aggregates/profiles/interfaces/UserResultWithFollow';
