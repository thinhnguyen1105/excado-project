...
export interface NewsService extends Service<News, FindNewsQuery, NewsRepository> {
  ...
  getRelatedNews: (req: any, res: any) => void;
  getSameOwnerNews: (req: any, res: any) => void;
  getPendingNews: (req: any, res: any) => void;
  approveNews: (id: string, data: Partial<News>, params: RequestParams<NewsRepository>) => Promise<{}>;
  rejectNews: (id: string, data: Partial<News>, params: RequestParams<NewsRepository>) => Promise<{}>;
}
